...
- Check for MILESTONE-CONTEXT.md (from /hive:discuss-milestone)
...
**Persist choice to config** (so future `/hive:plan-phase` honors it):
...
Spawn 4 parallel hive-project-researcher agents. Each uses this template with dimension-specific fields:
...
", subagent_type="hive-project-researcher", model="{researcher_model}", description="{DIMENSION} research")
```
...
`/hive:discuss-phase [N]` — gather context and clarify approach

<sub>`/clear` first → fresh context window</sub>

Also: `/hive:plan-phase [N]` — skip discussion, plan directly
```
...
- [ ] hive-roadmapper spawned with phase numbering context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md phases continue from previous milestone
- [ ] All commits made (if planning docs committed)
- [ ] User knows next step: `/hive:discuss-phase [N]`
