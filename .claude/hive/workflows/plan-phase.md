<purpose>
Create executable phase prompts (PLAN.md files) for a roadmap phase with integrated research and verification. Default flow: Research (if needed) -> Plan -> Verify -> Done. Orchestrates hive-phase-researcher, hive-planner, and hive-plan-checker agents with a revision loop (max 3 iterations).
</purpose>
...
<phase_context>
IMPORTANT: If CONTEXT.md exists below, it contains user decisions from /hive:discuss-phase.
...
## 8. Spawn hive-planner Agent

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Hive ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
**Phase Context:**
IMPORTANT: If context exists below, it contains USER DECISIONS from /hive:discuss-phase.
...
<downstream_consumer>
Output consumed by /hive:execute-phase. Plans need:
...
## 10. Spawn hive-plan-checker Agent

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Hive ► VERIFYING PLANS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- /hive:plan-phase {X} --research — re-research first
...
- [ ] hive-phase-researcher spawned with CONTEXT.md
- [ ] Existing plans checked
- [ ] hive-planner spawned with CONTEXT.md + RESEARCH.md
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] hive-plan-checker spawned with CONTEXT.md
