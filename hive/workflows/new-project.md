...
Auto mode requires an idea document via @ reference (e.g., `/hive:new-project --auto @prd.md`). If no document provided, error:

```
Error: --auto requires an idea document via @ reference.

Usage: /hive:new-project --auto @your-idea.md
...
**If `project_exists` is true:** Error — project already initialized. Use `/hive:progress`.
...
- options:
  - "Map codebase first" — Run /hive:map-codebase to understand existing architecture (Recommended)
  - "Skip mapping" — Proceed with project initialization

**If "Map codebase first":**
```
Run `/hive:map-codebase` first, then return to `/hive:new-project`
```
Exit command.
...
", subagent_type="hive-research-synthesizer", model="{synthesizer_model}", team_name="{RESEARCH_TEAM_NAME}", name="synthesizer", description="Synthesize research")
```
...
", subagent_type="hive-research-synthesizer", model="{synthesizer_model}", description="Synthesize research")
```
</standalone_mode>
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Hive ► CREATING ROADMAP
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

◆ Spawning roadmapper...
```

Spawn hive-roadmapper agent with context:
...
", subagent_type="hive-roadmapper", model="{roadmapper_model}", description="Create roadmap")
```
...
- Re-spawn roadmapper with revision context:
  ...
  ", subagent_type="hive-roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
...
/hive:discuss-phase 1 — gather context and clarify approach
...
**Also available:**
- /hive:plan-phase 1 — skip discussion, plan directly
...
- [ ] hive-roadmapper spawned with context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md created with phases, requirement mappings, success criteria
- [ ] STATE.md initialized
- [ ] REQUIREMENTS.md traceability updated
- [ ] User knows next step is `/hive:discuss-phase 1`
