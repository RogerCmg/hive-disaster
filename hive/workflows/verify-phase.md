...
Use hive-tools to extract must_haves from each PLAN:
...
Use hive-tools for artifact verification against must_haves in each PLAN:
...
Use hive-tools for key link verification against must_haves in each PLAN:
