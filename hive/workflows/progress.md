...
Run /hive:new-project to start a new project.
```

Exit.

If missing STATE.md: suggest `/hive:new-project`.

**If ROADMAP.md missing but PROJECT.md exists:**

This means a milestone was completed and archived. Go to **Route F** (between milestones).

If missing both ROADMAP.md and PROJECT.md: suggest `/hive:new-project`.
</step>
...
## Pending Todos
- [count] pending — /hive:check-todos to review

## Active Debug Sessions
- [count] active — /hive:debug to continue
...
`/hive:discuss-phase {phase}` — gather context and clarify approach
...
**Also available:**
- `/hive:plan-phase {phase}` — skip discussion, plan directly
- `/hive:list-phase-assumptions {phase}` — see Claude's assumptions
...
**Also available:**
- `/hive:execute-phase {phase}` — execute phase plans
- `/hive:verify-work {phase}` — run more UAT testing
...
`/hive:discuss-phase {Z+1}` — gather context and clarify approach
...
**Also available:**
- `/hive:plan-phase {Z+1}` — skip discussion, plan directly
- `/hive:verify-work {Z}` — user acceptance test before continuing
...
**Also available:**
- `/hive:verify-work` — user acceptance test before completing milestone
...
- Phase complete but next phase not planned → offer `/hive:plan-phase [next]`
- All work complete → offer milestone completion
- Blockers present → highlight before offering to continue
- Handoff file exists → mention it, offer `/hive:resume-work`
  </step>
...
- [ ] Smart routing: /hive:execute-phase if plans exist, /hive:plan-phase if not
- [ ] User confirms before any action
- [ ] Seamless handoff to appropriate hive command
      </success_criteria>
