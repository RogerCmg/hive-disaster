...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /hive:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/hive/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/hive/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/hive/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/hive/templates/discovery.md
...
Use ~/.claude/hive/templates/discovery.md.
...
1. Discuss phase context (/hive:discuss-phase [current-phase])
2. Create phase plan (/hive:plan-phase [current-phase])
