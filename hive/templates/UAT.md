...
- This section feeds directly into /hive:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /hive:plan-phase --gaps with root causes
...
**Creation:** When /hive:verify-work starts new session
