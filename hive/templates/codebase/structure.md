...
│   └── hive/           # Hive-specific commands
├── hive/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/hive/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `hive/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `hive/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/hive/workflows/{name}.md`

**New Reference Document:**
- Implementation: `hive/references/{name}.md`
