...
**Team mode:**
Re-run `/gsd:execute-phase {phase}` -> discover_plans finds completed SUMMARYs -> skips them -> creates NEW team for remaining plans -> resumes from first incomplete plan.
